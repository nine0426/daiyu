...
Saodang = False
# 稀世珍宝介绍初始化
treasure_introduction = {'照妖镜': '据说是那个人最珍贵的宝物', '艾尔登法环': '显然不如一百瓶雷碧',
...
def play_music():
    try:
        mixer.init()
        mixer.music.load(r'C:\ProgramData\DaiyuLinGototheJiaHome\music.mp3')
        mixer.music.play(-1)
        return 1
    except:
        pygame_quit()
        folder = os.path.exists(r'C:\ProgramData\DaiyuLinGototheJiaHome\music.mp3')
        if folder:
            os.remove(r'C:\ProgramData\DaiyuLinGototheJiaHome\music.mp3')
        return 0
...
# 商品函数化
def goods(name, need_gold_coins, explain='', showsomething='', hp=0, df=0, att=0, potion=0):
    print('=' * 25)
    print(name)
...
if __name__ == '__main__':
    ...
    # 根据存档信息判定是否播放音乐
    if load_data['set']['2']: load_data['set']['2'] = play_music()
    ...
    while True:
        ...
        while x == '2':
            ...
            try:
                ...
                if t == 0:
                    ...
                    print('=' * 21)
                    print('\033[1;33m稀世珍宝——%s\033[0m' % treasure_list[t])
                    print('%s' % treasure_introduction[treasure_list[t]])
                    print('=' * 21)
                    t = clear_input()
                else:
                    pass
        ...
        while x == '3':
            ...
            # 无敌药水
                ...
                load_data = goods('无敌药水', 1500, '属性:强行通过无法通过的关卡',
            ...
            # 属性加强药水
                ...
                load_data = goods('属性加强药水', 2000, '属性:增加生命1000/攻击300/防御200', hp=1000, att=300, df=200)
            # 查询无果
            else:
                continue
        # 小游戏面板循环
