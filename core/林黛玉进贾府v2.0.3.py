...
def save(gj, fy, sm, gq, jb, wdys, name, set1):
    file = "C:\ProgramData\DaiyuLinGototheJiaHome"
    Newfolder(file)
    file_save = open("C:\ProgramData\DaiyuLinGototheJiaHome\save.txt", "w")
    file_save.write("**save1 {} {} {} {} {} {} {} {}".format(gj, fy, sm, gq, jb, wdys, name, set1))
    file_save.close()
...
[3]商城''')
        ...
        if x == "1":
            ...
            while True:
                ...
                print("挑战")
                print("=======================================")
                print("目前你已解锁最新关卡为: %d/10" % (gq))
                print("已解锁英雄副本 %d/1"%(gq//11))
                print("请输入你要挑战的关卡数(英雄副本加上#前缀):")
                print("[0]返回首页")
                print("=======================================")
                p = clearInput()
                # 关卡判定器
                ...
                # 属性加强药水
                    ...
                    if g == "":
                        ...
                        try:
                            x = int(x)
                            if x > 0:
                                if jb > 499 * x and sm < 100000 and gj < 10000 and fy < 7000:
                                    print("=================")
                                    print("购买成功")
                                    jb = jb - 500 * x
                                    if jb < 10000:
        ...
        # 充值面板
            ...
            while True:
                ...
                if jb < 10000:
                    print("剩余金币: %d" % (jb))
                if jb >= 10000 and jb < 100000000:
                    print("剩余金币: %d万" % (jb // 10000))
                if jb >= 100000000 and jb < 1000000000000:
                    print("剩余金币: %d亿" % (jb // 100000000))
                if jb >= 1000000000000:
                    print("剩余金币：超出显示长度")
                ...
                try:
                    ...
                    if cz == 0:
                        ...
                        if sjh > 10000000000 and sjh < 20000000000:
                            ...
                            if cz < 10000:
                                print("充值%d金币成功" % (cz))
                            if cz >= 10000 and cz < 100000000:
                                print("充值%d金币成功" % (cz // 10000))
                            if cz >= 100000000 and cz < 1000000000000:
