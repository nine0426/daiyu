...
if __name__ == '__main__':
    ...
    Saodang = False
    # 稀世珍宝介绍初始化
    treasure_introduction = {'照妖镜': '据说是那个女人最珍贵的宝物', '艾尔登法环': '三小只其中的一人竟然不选择100瓶雷碧而选择了这样一个毫无特色的东西',
                             '史莱姆雕塑': '好像叫做利姆露来着...', '传送法典': '顾名思义可以传送', '如意金箍棒': '被我们打败的一个小人物的便携武器'}
            ...
            if t == '1':
                ...
                if t == '':
                    while True:
                        ...
                        print('[0]返回首页')
                        print('=' * 23)
                        a = clear_input('请输入你要抽奖的次数(最多10万)：')
                        fg = False
                        cn = 0
                        if a == '0':
                            clear()
                        ...
                        try:
                            a = int(a)
                            if load_data['gold_coins'] >= 10000 * a and 0<a<100000:
